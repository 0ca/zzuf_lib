...
#include <signal.h>
#if _WIN32
#	include "util/basename_windows.h"
#else
#	include <libgen.h>
#endif
#if _WIN32
...
__declspec(dllexport) void zzuf_fuzz_buffer(int seed, double ratio, char *buffer, int len);
...
int main(int argc, char *argv[])
{
	...
	zzuf_fuzz_buffer(seed, ratio, buffer, strlen(buffer));
	printf("Res: %s\n", buffer);
	return 0;
